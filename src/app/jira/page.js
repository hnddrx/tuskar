      ...
      <div className="mx-auto max-w-3xl space-y-6 px-4 py-6 sm:px-8">
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-5">
              ...
              <div className="space-y-3 rounded-lg bg-slate-50 p-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-slate-200 px-3 py-2 font-mono text-xs focus:border-slate-400 focus:outline-none"
                  />
                </div>
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2 border-t border-slate-100 pt-4">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-md bg-slate-900 px-3.5 py-2 text-sm font-medium text-white hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-40"
            >
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-md bg-slate-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-40"
          >
          ...
          <div className="mt-4 rounded-lg bg-slate-50 px-3 py-2.5 text-sm">
            <p className="text-slate-500">Last import result</p>
          ...
          <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-4">
            ...
            <label className="flex shrink-0 items-center gap-2 text-sm text-slate-600">
              ...
              <input
                ...
                className="w-14 rounded-md border border-slate-200 px-2 py-1 text-xs focus:border-slate-400 focus:outline-none"
              />
              min
            </label>
          </div>
