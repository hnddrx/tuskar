...
export default function TaskFiltersPanel({
  ...
  return (
    <div className="relative" ref={ref}>
        ...
        {activeCount > 0 && (
          <span
            className={`ml-0.5 flex h-4 min-w-4 items-center justify-center rounded-full px-1 text-[10px] font-semibold ${
              activeCount > 0 ? "bg-white text-slate-900" : ""
            }`}
          >
            {activeCount}
          </span>
      ...
      {open && (
        <div className="absolute right-0 z-40 mt-2 max-h-[75vh] w-[min(24rem,calc(100vw-2rem))] overflow-y-auto rounded-xl border border-slate-200 bg-white p-4 shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="mb-1.5 text-xs font-medium text-slate-500">Source</p>
